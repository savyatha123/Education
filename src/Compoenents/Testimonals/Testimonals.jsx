  ...
  return (
    ...
    <div className='slider'>
      <ul ref ={slider}>
        ...
        <p>Choosing to pursue my degree at Edustiy was one of the best decisions I've ever made. The supportive community, state-of-the-art facilities, and commitment to academic excellence have truly have truly exceeded my exception</p>
</div>
        </li>
        <li>
        <div className='slide'>
